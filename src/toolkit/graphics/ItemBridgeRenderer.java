...
public class ItemBridgeRenderer extends TRenderer.Renderer {
    ...
    protected void draw() {
        ...
        tiles.intersect(bounds, tile -> {
            ...
            if (building instanceof ItemBridgeBuild) {
                drawBridgeItem((ItemBridgeBuild) building);
            } else if (building instanceof JunctionBuild) {
                drawHiddenItem((JunctionBuild) building);
            } else if (building instanceof RouterBuild) {
                drawHiddenItem((RouterBuild) building);
            }
        });
    ...
    public static void drawBridgeItem(ItemBridgeBuild bridge) {
        ...
        if (bridge instanceof BufferedItemBridgeBuild) {
            drawHiddenItem((BufferedItemBridgeBuild) bridge);
        }
    }
